...
export default () => (
        <div className="flex flex-col justify-center h-20 bg-blue-400 px-10">
            <div className="flex text-center mx-20">
            ...
            <p className="pt-2 text-xs text-center block"> © 2020 Sho Hirose All right reserved.</p>
        </div>
)